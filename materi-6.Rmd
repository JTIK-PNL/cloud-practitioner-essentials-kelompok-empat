...
Keamanan adalah aspek kritis dalam berbagai bidang, baik itu dalam konteks fisik, digital, maupun informasi. Pemahaman dasar tentang keamanan membantu individu dan organisasi dalam melindungi aset, data, dan sistem dari berbagai ancaman.
Keamanan juga dapat diartikan sebagai perlindungan terhadap ancaman yang dapat merugikan. Ini mencakup pencegahan, deteksi, dan respons terhadap ancaman.

## Shared Responsibility Model

Shared Responsibility Model adalah kerangka kerja yang digunakan untuk membagi tanggung jawab keamanan antara penyedia layanan cloud dan pelanggan. Model ini sangat penting dalam lingkungan cloud computing karena membantu memastikan bahwa semua aspek keamanan tertangani dengan jelas dan efisien.
...
Perizinan dan hak akses pengguna adalah komponen kunci dalam strategi keamanan sistem informasi. Mereka berfungsi untuk mengatur siapa yang dapat mengakses berbagai sumber daya dalam sistem dan apa yang dapat mereka lakukan dengan sumber daya tersebut.

#### Perizinan (Permissions):

Perizinan merujuk pada hak yang diberikan kepada pengguna atau grup pengguna untuk melakukan tindakan tertentu pada suatu sumber daya atau objek dalam sistem. Contoh sumber daya ini bisa berupa file, folder, aplikasi, atau data dalam basis data. 

#### Hak Akses Pengguna (User Access Rights):

Hak akses pengguna adalah sekumpulan izin yang diberikan kepada pengguna untuk mengakses sumber daya dalam sistem. Hak akses ini ditentukan oleh administrator sistem dan bergantung pada peran atau posisi pengguna dalam organisasi.

## 
Implementasi hak akses biasanya melibatkan penggunaan akun pengguna unik, daftar kontrol akses (Access Control Lists, ACLs), dan sistem manajemen identitas serta akses (Identity and Access Management, IAM).Contoh Implementasi dalam AWS IAM
AWS Identity and Access Management (IAM) adalah layanan yang membantu mengelola akses ke layanan dan sumber daya AWS dengan aman. Fitur utama AWS IAM meliputi:

#### IAM Users

Mewakili individu yang berinteraksi dengan layanan AWS. Pengguna ini tidak memiliki izin secara default dan perlu diberikan izin melalui IAM policies.

#### IAM Policies

Dokumen yang mengizinkan atau menolak aktivitas tertentu terhadap layanan dan sumber daya AWS. Policies ini ditulis dalam format JSON dan mengatur tindakan spesifik yang dapat dilakukan pengguna

## 
#### IAM Groups

Mengelompokkan pengguna untuk memudahkan pengelolaan izin. Policy yang dilampirkan ke grup akan diterapkan ke semua anggota grup.

#### IAM Roles

Memberikan izin sementara untuk tindakan tertentu tanpa memerlukan kredensial pengguna. Roles ini berguna untuk memberikan akses sementara kepada pengguna atau layanan.

## AWS Organizations

AWS Organizations adalah layanan yang memungkinkan Anda untuk mengelola dan mengatur beberapa akun AWS dari satu lokasi pusat. Dengan AWS Organizations, Anda dapat:
...
##
#### Pengelompokan Hierarki Akun dalam AWS Organizations
Pengelompokan hierarki akun dalam AWS Organizations berarti mengorganisir akun-akun AWS ke dalam Organizational Units (OU) untuk mempermudah pengelolaan.

* Keamanan
* Kepatuhan (Compliance)
* Pengelolaan Anggaran
* Pewarisan Kebijakan (Policy Inheritance)
* Isolasi Beban Kerja

##
#### Studi Kasus: Implementasi AWS Organizations

Bayangkan Anda memiliki bisnis dengan akun AWS terpisah untuk setiap departemen: Keuangan, IT, HR, dan Hukum. Anda memutuskan untuk menggabungkan akun-akun ini dalam satu organisasi untuk memudahkan manajemen.

* Mengelompokkan Akun

* Membuat OU untuk HR dan Hukum
